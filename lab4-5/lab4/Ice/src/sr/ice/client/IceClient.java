...
public class IceClient {
	public static void main(String[] args) {
		...
		try {
			...
			ObjectPrx base2 = communicator.stringToProxy("calc/calc33:tcp -h 127.0.0.1 -p 10000 -z : udp -h 127.0.0.1 -p 10000 -z");
				...
				try {
					...
					switch (line) {
						case "add3":
							...
							break;
						case "add":
//							System.out.println("Symulacja opóźnienia. Proszę czekać...");
//							Thread.sleep(10000);
						...
						case "add-with-ctx": //wysłanie dodatkowych danych stanowiących kontekst wywołania
							...
							break;
						case "avg":
							double avg = obj1.avg(new long[]{1L, 2L, 3L, 4L, 5L, 6L, 6L, 8L, 9L, 0L});
